...
@section('content')
    ...
    <div class=" justify-content-end">
        <div class="container" style="max-width: 80%; margin: 0 50px 0 0">
            ...
            <a href="" class="btn btn-secondary mb-3">Export Data Keterlambatan</a>
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="{{ route('late.data') }}">Keseluruhan Data</a>
        </li>
        <li class="nav-item">
    ...
    <!-- Form Pencarian -->
<form class="mt-3" action="{{ route('late.data') }}" method="GET">
    <div class="input-group">
