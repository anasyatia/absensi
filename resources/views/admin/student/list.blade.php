    ...
    <div class="page-container">
        <div class="head-list">
            <div class="d-flex justify-content-start w-100 p-2">
                <a href="{{ url('student/create') }}" class="btn btn-primary" data-mdb-ripple-init>Tambah</a>
            </div>
            ...
            <tbody>
                ...
                @foreach ($students as $item)
                    <tr>
                        ...
                        <td class="d-flex">
                            <a style="margin-right: 20px"  href="{{ route('student.edit', $item['id']) }}" class="btn btn-primary">Edit</a>
