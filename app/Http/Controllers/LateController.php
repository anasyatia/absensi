...
public function index(Request $request)
{
    ...
    return view('admin.late.index', compact('late', 's', 'request')); // Sertakan variabel $request di sini
}
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('late.data')->with('success', 'Berhasil menambahkan data keterlambatan!');
    }
    ...
    public function show($student_id)
    {
        ...
        return view('admin.late.show', compact('late',));
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('late.data')->with('success', 'Berhasil menghapus data kekterlambatan');
    }
